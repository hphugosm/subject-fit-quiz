const CS = {
  ...
  heroSubtitle: 'Krátký chytrý quiz ukáže, co tě nejvíc vystihuje, a doporučí vhodné směry.',
  features: [
...
const CS_QUESTION_TEXT = {
  ...
  q15: {
    prompt: 'Jak moc ti zatím dává smysl, kam se quiz profilově ubírá?',
